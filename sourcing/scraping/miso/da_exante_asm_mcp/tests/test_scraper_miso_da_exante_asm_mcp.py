"""Tests for MISO Day-Ahead Ex-Ante ASM MCP scraper."""
...
from sourcing.scraping.miso.da_exante_asm_mcp.scraper_miso_da_exante_asm_mcp import (
    MisoDayAheadExAnteASMMCPCollector
)
...
def collector():
    ...
    mock_redis = Mock()
    return MisoDayAheadExAnteASMMCPCollector(
...
class TestGenerateCandidates:
    ...
    def test_generate_candidates_single_day(self, collector):
        ...
        assert candidates[0].identifier == "da_exante_asm_mcp_20240101.json"
    ...
    def test_candidate_metadata(self, collector):
        ...
        assert metadata["data_type"] == "da_exante_asm_mcp"
